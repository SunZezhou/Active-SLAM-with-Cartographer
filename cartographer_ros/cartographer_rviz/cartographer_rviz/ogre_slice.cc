...
void OgreSlice::Update(
    ...
    const ::std::array<double, 4>& special_color) {
  ...
  pass->getFragmentProgramParameters()->setNamedConstant("special_color", Ogre::Vector4{(float)special_color[0], (float)special_color[1], (float)special_color[2], (float)special_color[3]});
