...
std::shared_ptr<::cartographer::io::SubmapTextures> FetchSubmapTextures(
    ...
    ros::ServiceClient* client, std::array<double, 4>* special_color) {
  ...
  auto color = srv.response.special_color;
  if(special_color != nullptr) *special_color = {{color[0], color[1], color[2], color[3]}};
